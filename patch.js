...
const logoCode = `
    ...
    doc.roundedRect(marginL, y, 12, 12, 3, 3, "F");
    doc.setFont("Helvetica", "bold");
    doc.setFontSize(16);
    doc.setTextColor(255, 255, 255);
    doc.text("K", marginL + 3.5, y + 8.5);
    
    doc.setFontSize(18);
    doc.setTextColor(109, 40, 217);
    doc.text("KARTIGO", marginL + 16, y + 8.5);
    
    doc.setFont("Helvetica", "normal");
    doc.setFontSize(7);
    doc.setTextColor(100, 116, 139);
    doc.text("DRAFT & AUTOMATION", marginL + 16, y + 12);
    
    y += 18;
`;

if(!code.includes("doc.roundedRect(marginL, y, 12, 12")) {
